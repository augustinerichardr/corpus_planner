      ...
      child: ListView(
        children: [
          ...
          SliderInput(
            ...
            max: 100000000,
            divisions: 99,
            displayValue: formatCurrency(startingCorpus),
            onChanged: (v) => onChanged('startingCorpus', v),
          ),
          SliderInput(
            ...
            max: 500000,
            divisions: 98,
            displayValue: formatCurrency(monthlyWithdrawal),
            onChanged: (v) => onChanged('monthlyWithdrawal', v),
          ),
          const Divider(color: Colors.white24, height: 32),
          SliderInput(
            label: 'Portfolio Yield % (Post-Retirement)',
            value: returnRate,
            min: 4,
            max: 15,
            divisions: 22,
            displayValue: '${returnRate.toStringAsFixed(1)}%',
            onChanged: (v) => onChanged('returnRate', v),
          ),
          SliderInput(
            ...
            max: 12,
            divisions: 12,
            displayValue: '${inflation.toStringAsFixed(1)}%',
            onChanged: (v) => onChanged('inflation', v),
          ),
          SliderInput(
            ...
            onChanged: (v) => onChanged('durationYears', v),
          ),
        ],
      ),
    );
