    ...
    return ListView(
      ...
      children: [
        ...
        _buildWrapperCard(
          ...
          title: 'How Arbitrage Mutual Funds Generate Zero-Risk Returns',
          ...
          child: LayoutBuilder(
            builder: (context, constraints) {
              ...
              final step1 = _buildStepCard(
                stepNumber: '1',
                title: '1. Buy Cash Stock',
                desc: 'Buy Reliance at ₹3,000 in cash market.',
                accentColor: const Color(0xFF38BDF8),
              );
              final step2 = _buildStepCard(
                stepNumber: '2',
                title: '2. Sell Month Future',
                desc: 'Simultaneously sell Future at ₹3,020.',
                accentColor: const Color(0xFFF59E0B),
              );
              final step3 = _buildStepCard(
                stepNumber: '3',
                title: '3. Locked Expiry Gain',
                desc:
        ...
        _buildWrapperCard(
          ...
          title: 'Post-Tax Alpha: Arbitrage vs. Bank FD vs. Liquid Debt',
          badge: '30% Tax Slab Basis',
          ...
          child: LayoutBuilder(
            builder: (context, constraints) {
              ...
              final arbLtcg = _buildTaxPill(
                title: 'Arbitrage (>1 Year)',
                taxTag: '12.5% LTCG Tax Rate',
                netYield: '~7.1% Net',
        ...
        _buildWrapperCard(
          ...
          title: 'Top Direct Arbitrage Mutual Funds in India',
          badge: 'Zero Lock-In',
