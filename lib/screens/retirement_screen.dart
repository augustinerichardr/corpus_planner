              ...
              child: Column(
                children: [
                  Row(
                    children: [
                      MetricCard(
                        title: 'Starting Corpus',
                        value: formatCompactCurrency(startingCorpus),
                        color: const Color(0xFF29B6F6),
                      ),
                      const SizedBox(width: 12),
                      MetricCard(
                        title: 'Total Withdrawn Income',
                      ...
                      MetricCard(
                        ...
                        value: formatCompactCurrency(finalBalance),
                            ...
                            child: ListView.builder(
                              ...
                              itemBuilder: (_, idx) {
                                ...
                                return ListTile(
                                  ...
                                  subtitle: Text(
                                    'Monthly Income: ${formatCompactCurrency(r.monthlyWithdrawal)}',
                                  ),
                                  trailing: Text(
                                    'Remaining: ${formatCompactCurrency(r.remainingCorpus)}',
                                    style: TextStyle(
